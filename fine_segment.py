# -*- coding: utf-8 -*-
"""
# Copyright (c) 2018 LinkDoc, Inc. All Rights Reserved
# @file name    : fine_segment.py
# @author       : xiangluo@linkdoc.com
# @date         : 2018-12-10 10:41
# @brief        : traditional image process lung segmentation and postprocess
"""
...
def segment_lung_mask(ct_series, chest_th=-500, lung_th=-320, min_object_size=10, max_areas=250000, min_areas=2000):
    ...
    fine_mask, num_regions = largest_one_or_two_label_volume(fine_mask, temp_x < lung_th, bg=0, is_local=is_local, is_circle=is_circle)
